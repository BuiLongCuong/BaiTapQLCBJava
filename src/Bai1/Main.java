...
//        for (Map.Entry<Integer, Bai1.Bai1.Student> arrStudent : clazz.showAll().entrySet()) {
            ...
            switch (choice){
                ...
                case 3:
                    ...
                    if(clazz.findById(editId)!=-1){
                        ...
                        System.out.println("Nhập điểm môn Toán:");
                        double editToan = Validate.getScores(input);
                        editArrScores[0]=editToan;
                        System.out.println("Nhập điểm môn Văn:");
                        double editVan = Validate.getScores(input);
                        editArrScores[1]=editVan;
                        System.out.println("Nhập điểm môn Anh:");
                        double editAnh = Validate.getScores(input);
                ...
                case 4:
                    ...
                    int id = Validate.inputNumber(input);
